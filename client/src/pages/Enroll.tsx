...
import TrialCheckout from "@/components/trial/TrialCheckout";
import {
...
export default function Enroll() {
  ...
  const isTrialMode = new URLSearchParams(search).get("mode") === "trial";
  if (isTrialMode) return <TrialCheckout />;
